...
import Lab7_5.service.StudentService;

import java.util.List;

@SpringBootApplication
public class Lab7_5Application implements CommandLineRunner {

	@Autowired
	private StudentService studentService;

	public static void main(String[] args) {
		SpringApplication.run(Lab7_5Application.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		System.out.println(
				"The number of students with Ielts score of 7.0 is " + studentService.countStudentsWithIeltsScore(7.0));
